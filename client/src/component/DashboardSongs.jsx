      ...
      <div className="w-full p-4 items-center justify-center flex flex-col">
        <div className="w-full flex justify-center items-center gap-20">
          <NavLink
            ...
            className="flex items-center justify-center px-4 py-4 border rounded-md border-gray-300 hover:border-gray-500 hover:shadow-md cursor-pointer"
          >
            <IoAdd />
          </NavLink>
          <input
            ...
            className={`w-52 px-4 py-2 border ${
              isFocus ? "border-gray-900" : "border-gray-300"
